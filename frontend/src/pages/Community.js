...
const Community = () => {
  ...
  return (
    <Container fixed sx={{ my: 2, pb: 10 }}>
      <Grid container spacing={0} direction='column' alignItems='center'>
        <Unity
          style={{ width: "1080px", height: "720px", background: "grey" }}
      ...
      >
        <Grid item xs={1}>
          <Button variant='contained' onClick={handleOnClickTakeScreenshot}>
            스크린샷
          </Button>
        </Grid>
        <Grid item xs={1}>
          <Button variant='contained' onClick={handleOnClickFullscreen}>
            Fullscreen
          </Button>
        </Grid>
      </Grid>
      ...
      닉네임을 Guest(대소문자 구별)로 변경하실 경우, SSAFY NFT 티켓이 없으셔도
      커뮤니티에 들어가실 수 있게 열어두었습니다.
