...
const TicketImage = (props) => {
  ...
  return (
    <div>
      <PosterArea>
        {typeof props.posterUri !== "undefined" ? (
          <Poster
            src={`https://nfticket.plus/showipfs/ipfs/${props.posterUri}`}
            alt="poster img"
          ></Poster>
        ) : (
          <Poster src="images/poster_default.jpeg" alt="poster img"></Poster>
        )}
        <TicketData>
          <TicketTitle>
            <div
            ...
            >
              ...
              <img
                ...
                alt=""
                style={{ width: "14px", height: "14px", marginTop: "2px", marginBottom: "0px" }}
              ></img>
