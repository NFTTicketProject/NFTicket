    ...
    return (
      <div>
        <GuideBodyComponent
          icon=''
          title='서비스 제공환경'
          body='Besu 환경에서 MetaMask 지갑 관리 프로그램을 사용한 로그인과 인증 서명기능이 제공됩니다.
NFTicket의 거래는 MetaMask로 연동된 지갑 계정 내의 가상화폐를 사용합니다.'
        />
        <GuideBodyComponent
          icon=''
          title='회원가입'
          body='MetaMask에 지갑을 연결하여 회원가입 후, 닉네임, 자기소개 정보 등을 추가적으로 입력하실 수 있습니다.'
        />
      </div>
    );
  } else if (pageNum === 4) {
    ...
    return (
      <div>
        <GuideBodyComponent
          icon=''
          title='티켓 구매하기'
          body='판매자가 등록한 티켓을 이더리움/ 코인을 사용하여 구매할 수 있습니다.
구매자는 구입한 티켓에 발행량에 따라 즉각 구입할 수 있고, 관련 티켓의 소유권과 NFT를 지급받게 됩니다.'
        />
        <GuideBodyComponent
          icon=''
          title='수수료'
    ...
    return (
      <div>
        <GuideBodyComponent
          icon=''
          title='판매자 등록'
          body='티켓을 판매하거나 저희 서비스/ 플랫폼을 이용하기 위해서는 판매자로 등록하실 필요가 있습니다. 저희는 발행된 티켓에 대해 어떠한 책임도 지지 않습니다.'
        />
        <GuideBodyComponent icon='' title='판매자 등록 방법' body='미완성' />
        <GuideBodyComponent
          icon=''
          title='판매시 설정 가능한 옵션'
